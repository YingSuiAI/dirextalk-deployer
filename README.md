...
This deployer provisions the user-owned Personal Node shown in the architecture
below. It does not deploy the central Dirextalk Platform service or the mobile
app.

![Dirextalk communication architecture](assets/dirextalk-communication-architecture.png)
