...
const affectedRules = [
  ...
  [/^scripts\/phases\/s4_|^scripts\/cloud-init\/|^scripts\/render\//, ["tests/render_userdata_remote_nodes_test.sh", "tests/split_agent_bundle_test.sh", "tests/updater_bundle_test.sh", "tests/updater_bootstrap_resume_test.sh", "tests/split_source_revision_advance_test.sh", "tests/host_integration_atomic_test.sh"]],
  ...
  [/^scripts\/orchestrate\.sh$/, ["tests/orchestrate_status_recovery_test.sh", "tests/orchestrate_region_env_test.sh", "tests/orchestrate_expected_negative_test.sh", "tests/final_delivery_runtime_gate_test.sh"]],
