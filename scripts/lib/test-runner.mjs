...
const slowTests = [
  ...
  "tests/orchestrate_expected_negative_test.sh",
  "tests/orchestrate_lock_test.sh",
  ...
  "tests/split_source_revision_advance_test.sh",
  "tests/host_integration_atomic_test.sh",
  "tests/static_sites_edge_test.sh",
  "tests/split_runtime_docker_test.sh",
...
const affectedRules = [
  ...
  [/^scripts\/lib\/json(?:-worker)?\.mjs$|^scripts\/lib\/json\.sh$|^scripts\/json\.mjs$/, ["tests/json_helper_test.sh", "tests/atomic_write_test.sh", "tests/existing_node_update_test.sh"]],
  ...
  [/^scripts\/lib\/production-release-resolver\.mjs$/, ["tests/production_release_resolver_test.mjs", "tests/server_release_test.sh"]],
  [/^scripts\/render\/prepare-production-release\.sh$/, ["tests/production_release_prepare_test.sh"]],
  ...
  [/^scripts\/phases\/remote_dns_probe\.py$/, ["tests/remote_dns_probe_test.sh", "tests/s3_lightsail_provision_test.sh", "tests/s3_ec2_updater_upload_test.sh"]],
  ...
  [/^scripts\/lib\/ops\.sh$|^scripts\/(?:update|reset-app-data)\.sh$/, ["tests/update_reset_ops_test.sh", "tests/existing_node_update_test.sh", "tests/operation_report_test.sh"]],
  [/^scripts\/orchestrate\.sh$/, ["tests/orchestrate_status_recovery_test.sh", "tests/orchestrate_region_env_test.sh", "tests/orchestrate_expected_negative_test.sh", "tests/orchestrate_lock_test.sh", "tests/final_delivery_runtime_gate_test.sh"]],
