...
const affectedRules = [
  ...
  [/^scripts\/lib\/operation_report\.sh$/, ["tests/operation_report_test.sh", "tests/final_delivery_runtime_gate_test.sh", "tests/user_confirmation_gates_test.sh"]],
  ...
  [/^scripts\/orchestrate\.sh$/, ["tests/orchestrate_status_recovery_test.sh", "tests/orchestrate_region_env_test.sh", "tests/user_confirmation_gates_test.sh", "tests/final_delivery_runtime_gate_test.sh"]],
