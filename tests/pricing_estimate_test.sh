...
case "${1:-} ${2:-}" in
  "lightsail get-bundles")
    printf '{"bundles":[{"bundleId":"small_2_0","price":12,"ramSizeInGb":2,"diskSizeInGb":60,"transferPerMonthInGb":3072,"cpuCount":1,"isActive":true,"supportedPlatforms":["LINUX_UNIX"]},{"bundleId":"small_inactive","price":12,"ramSizeInGb":2,"diskSizeInGb":60,"transferPerMonthInGb":3072,"cpuCount":2,"isActive":false,"supportedPlatforms":["LINUX_UNIX"]},{"bundleId":"nano_3_1","price":5,"ramSizeInGb":0.5,"diskSizeInGb":20,"transferPerMonthInGb":1024,"cpuCount":2,"isActive":true,"supportedPlatforms":["LINUX_UNIX"]},{"bundleId":"small_3_1","price":12,"ramSizeInGb":2,"diskSizeInGb":60,"transferPerMonthInGb":3072,"cpuCount":2,"isActive":true,"supportedPlatforms":["LINUX_UNIX"]}]}\n'
    exit 0
    ;;
...
json_test_check "$tmp/lightsail.json" "data.provider === 'lightsail' && data.pricing_status === 'bundle_price_recorded' && data.components.lightsail_bundle.bundle_id === 'small_3_1' && data.components.lightsail_bundle.monthly_usd === 12 && data.components.lightsail_bundle.ram_gb === 2 && data.components.lightsail_bundle.disk_gb === 60 && data.components.lightsail_bundle.cpu_count === 2 && data.total_monthly_usd === 12"
