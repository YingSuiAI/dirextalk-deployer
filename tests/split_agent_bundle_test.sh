...
grep -Fq 'cloud-init/split/WorkerEdge.haproxy.cfg' "$ROOT/scripts/phases/s3_provision.sh"
grep -Fq 'cloud-init/split/edge-compose.override.yaml' "$ROOT/scripts/phases/s3_provision.sh"
grep -Fq 'cloud-init/split/worker-edge-compose.yaml' "$ROOT/scripts/phases/s3_provision.sh"
grep -Fq 'cloud-init/split/verify-worker-edge-image.sh' "$ROOT/scripts/phases/s3_provision.sh"
